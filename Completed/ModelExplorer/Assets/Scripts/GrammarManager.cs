...
public class GrammarManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.Log("Please specify an SRGS file name in GrammarManager.cs on " + name + ".");
            Debug.Log("Please check your GameObject settings in GrammarManager.cs on " + name + ".");
            return;
        }
    ...
    private void GrammarRecognizer_OnPhraseRecognized(PhraseRecognizedEventArgs args)
    {
        ...
        foreach (SemanticMeaning meaning in meanings)
        {
            ...
            string shape = meaning.key;
            string color = meaning.values[0];
