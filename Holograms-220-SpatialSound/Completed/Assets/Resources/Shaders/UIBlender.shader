...
//Simple texture blending shader. To be used with vbuttons or UI's where a smooth transition between states is needed.
...
Shader "UIBlender" {
	Properties{
		...
		//Brightness hack, should clean up.
		//[HDR] _Tint("HDR Tint", Color) = (1,1,1,0)
	}
